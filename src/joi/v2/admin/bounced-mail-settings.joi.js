...
const bouncedMailSettingSchema = Joi.object({
  bounced_settings_id: Joi.number(),
  priority: Joi.number()
    .valid(...Object.values(SETTING_LEVELS))
    .required(),
  automatic_bounced_data: Joi.object({
    mail: Joi.boolean(),
  ...
  semi_automatic_bounced_data: Joi.object({
    mail: Joi.boolean(),
    automated_mail: Joi.boolean(),
    call: Joi.boolean(),
    message: Joi.boolean(),
...
module.exports = bouncedMailSettingSchema;
